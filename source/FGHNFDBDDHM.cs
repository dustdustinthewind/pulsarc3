...
internal class FGHNFDBDDHM<T> where T : struct, EDNENBIDEGJ
{
	...
	public void NENOGJGOIKO(MonoBehaviour IIKBNPGPICN)
	{
		KAKFICCIFEM = IIKBNPGPICN;
	}
	...
	public void MOKHHEMAJBJ(MonoBehaviour IIKBNPGPICN)
	{
		KAKFICCIFEM = IIKBNPGPICN;
	}
	...
	public void IFINBHBFCBB(MonoBehaviour IIKBNPGPICN)
	{
		KAKFICCIFEM = IIKBNPGPICN;
	}
	...
	public void StartTween(T DAGALCAILLN)
	{
		...
		if (KNFPOOFKLCB != null)
		{
			KAKFICCIFEM.StopCoroutine(KNFPOOFKLCB);
			KNFPOOFKLCB = null;
		}
		if (!KAKFICCIFEM.gameObject.activeInHierarchy)
		{
			DAGALCAILLN.TweenValue(1f);
			return;
		}
		KNFPOOFKLCB = PLHNHMOGGDN(DAGALCAILLN);
	...
	private static IEnumerator PLHNHMOGGDN(T LHNAHCPGCFH)
	{
